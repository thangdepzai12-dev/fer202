...
export default function HomeCarousel() {
  ...
  return (
    <Carousel interval={3000} className="main-carousel" data-bs-theme="dark">
      {carouselMovies.map(m => (
        <Carousel.Item key={m.id}>
          ...
          <Carousel.Caption className="text-start" style={{
            ...
            <h3 className="mb-1">
              {m.title} <Badge bg="info" className="text-dark badge-genre">{m.genre}</Badge> <Badge bg="secondary">{m.year}</Badge>
            </h3>
